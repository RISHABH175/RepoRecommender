...
with st.form(key="form1"):
  tagL = st.text_input(
    'Enter your interests and preferred languages(comma seperated)')
  ...
  if submit:
    ...
    df['Url'] = "http://github.com/" + df['Username'] + "/" + df[
      'Repository Name']
    ...
    RAGE_TAGS_LIST = [
      'github', 'algorithms', 'learn', 'learning', 'http', 'https'
    ]
    ...
    repos.extend([
      "Interested Repo"
    ])  # We add to the csv reponame list, the repo name from github
    # print(repos)
...
if add_rating:
  feedback = {"username": "Random_User", "rating": rating}
